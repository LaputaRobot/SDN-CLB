...
flowNumX = [float(l[0]) - 1627118359.8546093 for l in flowNum]
f = open('./topo/flowNum.log')
flowNum = csv.reader(f)
flowNumY = [float(l[2]) * 6 for l in flowNum]
...
ax.plot(con1X, sumY, label=lable.format(1), linewidth=0.7)
ax.plot(flowNumX, flowNumY, label=lable.format(1), linewidth=0.7)
